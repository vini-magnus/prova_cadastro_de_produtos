...
<?php
    ...
    //implementando os arquivos necessários para este script
    ...
    //usando condicional if para verificar se foi enviado algo pelo usuário (afim de evitar erros)
    if(!empty($dadosFormulario['enviar'])){
    

    //declarando a variável frase que contém a frase digitada pelo usuário
    $frase = $_POST['frase'];
